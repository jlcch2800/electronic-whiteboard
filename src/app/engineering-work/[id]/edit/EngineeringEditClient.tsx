...
export default function EngineeringEditClient({ initialData }: { initialData: any }) {
            ...
            <main className="max-w-3xl mx-auto p-6">
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                    <form onSubmit={handleSubmit(onPreSubmit)} className="space-y-6">
                        ...
                        <SubmitButton isSubmitting={isSubmitting} isSuccess={isSuccess} label="儲存修改" className="bg-amber-500 hover:bg-amber-600" />
                    </form>
                </motion.div>
            </main>
